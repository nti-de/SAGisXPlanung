...
class XP_ExterneReferenz(RelationshipMixin, ElementOrderMixin, Base):
    ...
    bp_ausgleichsmassnahme_massnahme = relationship("BP_AusgleichsMassnahme",
                                                    foreign_keys=[bp_ausgleichsmassnahme_massnahme_id],
                                                    back_populates="refMassnahmenText")

    bp_ausgleichsmassnahme_plan_id = Column(UUID(as_uuid=True), ForeignKey('bp_ausgleichsmassnahme.id', ondelete='CASCADE'))
    bp_ausgleichsmassnahme_plan = relationship("BP_AusgleichsMassnahme",
                                               foreign_keys=[bp_ausgleichsmassnahme_plan_id],
                                               back_populates="refLandschaftsplan")
...
class XP_SPEMassnahmenDaten(RelationshipMixin, ElementOrderMixin, Base):
    ...
    bp_ausgleichsmassnahme_id = Column(UUID(as_uuid=True), ForeignKey('bp_ausgleichsmassnahme.id', ondelete='CASCADE'))
    bp_ausgleichsmassnahme = relationship('BP_AusgleichsMassnahme', back_populates='massnahme')
