...
<qgis styleCategories="Symbology" version="3.44.6-Solothurn">
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol alpha="1" clip_to_extent="0" force_rhr="0" is_animated="0" name="0" type="fill" frame_rate="10">
        ...
        <layer enabled="1" class="SimpleLine" pass="0" id="{b5b95e52-5eae-4e02-892e-5a7e832645d3}" locked="0">
          <Option type="Map">
        ...
        <layer enabled="1" class="SimpleLine" pass="0" id="{7e3151c6-0f5d-43a7-a1a9-f9fb3b3b78fa}" locked="0">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="square" name="capstyle" type="QString"/>
            <Option value="5;2" name="customdash" type="QString"/>
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="miter" name="joinstyle" type="QString"/>
            <Option value="22,206,60,255,rgb:0.0862745,0.8078431,0.2352941,1" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
            <Option value="2.5" name="line_width" type="QString"/>
            <Option value="MapUnit" name="line_width_unit" type="QString"/>
            <Option value="1.25" name="offset" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="offset_unit" type="QString"/>
            <Option value="0" name="ring_filter" type="QString"/>
            <Option value="0" name="trim_distance_end" type="QString"/>
        ...
        <layer enabled="1" class="MarkerLine" pass="0" id="{b5912de0-661b-4a0f-b2c8-9b0c249ee491}" locked="0">
          <Option type="Map">
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0" name="@0@2" type="marker" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" class="FontMarker" pass="0" id="{39bd2014-4ede-4311-8830-78fbacb68343}" locked="0">
              <Option type="Map">
                <Option value="-0.5" name="angle" type="QString"/>
                <Option value="T" name="chr" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0" name="" type="fill" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" class="SimpleFill" pass="0" id="{d4fe1bd8-18f5-4c74-9047-a6dd29a39947}" locked="0">
          <Option type="Map">
