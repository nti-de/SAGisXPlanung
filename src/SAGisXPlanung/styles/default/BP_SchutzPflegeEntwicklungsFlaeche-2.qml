...
<qgis styleCategories="LayerConfiguration|Symbology" version="3.34.1-Prizren" readOnly="0">
  <flags>
  ...
  <renderer-v2 type="singleSymbol" symbollevels="0" enableorderby="0" referencescale="-1" forceraster="0">
    <symbols>
      <symbol alpha="1" clip_to_extent="0" is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="0">
        ...
        <layer id="{b5b95e52-5eae-4e02-892e-5a7e832645d3}" locked="0" class="SimpleLine" pass="0" enabled="1">
          <Option type="Map">
        ...
        <layer id="{7e3151c6-0f5d-43a7-a1a9-f9fb3b3b78fa}" locked="0" class="SimpleLine" pass="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="0" name="draw_inside_polygon"/>
            <Option type="QString" value="miter" name="joinstyle"/>
            <Option type="QString" value="22,206,60,255" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
        ...
        <layer id="{b5912de0-661b-4a0f-b2c8-9b0c249ee491}" locked="0" class="MarkerLine" pass="0" enabled="1">
          <Option type="Map">
          ...
          <symbol alpha="1" clip_to_extent="1" is_animated="0" type="marker" frame_rate="10" force_rhr="0" name="@0@2">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" is_animated="0" type="fill" frame_rate="10" force_rhr="0" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{b8644120-3680-4d6a-a527-f78c2169ffee}" locked="0" class="SimpleFill" pass="0" enabled="1">
          <Option type="Map">
